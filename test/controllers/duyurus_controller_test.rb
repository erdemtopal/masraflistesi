...
class DuyurusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create duyuru" do
    assert_difference('Duyuru.count') do
      post duyurus_url, params: { duyuru: { admin_id: @duyuru.admin_id, body: @duyuru.body, title: @duyuru.title } }
    end
  ...
  test "should update duyuru" do
    patch duyuru_url(@duyuru), params: { duyuru: { admin_id: @duyuru.admin_id, body: @duyuru.body, title: @duyuru.title } }
